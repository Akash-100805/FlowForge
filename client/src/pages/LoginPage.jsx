    ...
    <div className="min-h-screen bg-primary flex animate-fade-in">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center px-8 sm:px-16 relative">
        <div className="w-full max-w-md">
          ...
          <h1 className="text-4xl font-bold text-text-primary mb-2">Hello Again!</h1>
          <p className="text-text-secondary mb-10">Let's get started with your tasks.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button type="submit" disabled={loading} className="w-full btn-accent shadow-lg shadow-accent/20">
